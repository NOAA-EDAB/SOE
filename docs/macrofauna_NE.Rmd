...
<span style="color: red;">ONLY ME/NH NEW DATA</span>

#### NEFSC BTS
 
<span style="color: red;">NO NEW DATA - NO SURVEY IN 2020</span>
 
```{r aggregate-biomass, fig.cap = paste0("Spring (left) and fall (right) NEFSC surveyed biomass in Georges Bank.")}
...
```{r agg-bio, fig.cap = paste0("Spring (left) and fall (right) NEFSC surveyed biomass in the Gulf of Maine.")}
...
knitr::include_graphics(c(file.path(image.dir, "GOMcondition_2020_viridis_final.jpg"),file.path(image.dir, "GBcondition_2020_viridis_final.jpg") ))
